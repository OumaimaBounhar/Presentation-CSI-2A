...
\begin{tikzpicture}[
  ...
  angray/.style={-{Stealth}, violet!80!black, dotted, line width=1.1pt},
  ...
  cellang/.style={fill=violet!25, draw=black},
  ...
  \foreach \i/\y/\style in {1/3.2/cellvalid, 2/1.6/cellobst, 3/0.0/cellvalid, 4/-1.6/cellang, 5/-3.2/cellobst} {
    \node[\style, minimum width=0.55cm, minimum height=0.85cm] (c\i) at (0,\y) {$c_\mathrm{\i}$};
  }
  \node[align=center] at (0,4.15) {RIS: $\mathrm{N}$ unit cells};
  ...
  \node[violet!80!black, align=left, anchor=north] at (-1.4,-1.75) {$\cos\theta_\mathrm{i}\le 0$ or\\$\cos\theta_\mathrm{m}\le 0$};
